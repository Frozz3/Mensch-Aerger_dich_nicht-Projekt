...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 27. Apr 2023 um 22:34
...
(100, 'UserDcCTrW', 'f52af8a3-a670-4a76-9a74-4e602e11399a');
...
ALTER TABLE `login_data`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `login_data_ibfk_1` (`usersId`);
...
--
ALTER TABLE `users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134214;
